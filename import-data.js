...
const generalFaqs = [
  {
    ...
    answer: "We install a wide range of security systems including CCTV cameras (IP and Analog), Biometric Attendance Systems, Access Control Systems, Video Door Phones, and Visitor Management Systems from top global brands."
  },
  {
    question: "Do you provide installation services outside Mumbai?",
    answer: "Our primary focus is Mumbai and Andheri, but we do take up larger corporate or industrial projects in surrounding areas like Thane, Navi Mumbai, and Palghar depending on the project scope."
  },
  {
    question: "Do you offer maintenance and support after installation?",
    answer: "Yes, absolutely! We provide comprehensive Annual Maintenance Contracts (AMC) and 24/7 technical support to ensure your security systems are always functioning optimally."
  },
  {
    question: "How long does a typical installation take?",
    answer: "The installation time depends on the size of the premises and the number of cameras/devices. A standard office setup might take 1-2 days, while larger industrial projects could take a few weeks. We always provide a timeline before starting the work."
  },
  {
    question: "Are your technicians trained and certified?",
    answer: "Our technicians are highly trained and regularly updated on the latest technologies directly by our OEM partners. We ensure neat, professional, and precise installations every time."
  }
];
...
async function seedData() {
  ...
  for (let i = 0; i < generalFaqs.length; i++) {
    const doc = {
      _type: 'generalFaq',
      question: generalFaqs[i].question,
      answer: generalFaqs[i].answer,
      order: i,
    };
  ...
  for (let i = 0; i < brandData.length; i++) {
    ...
    await client.create(doc);
    console.log(`Created Brand: ${brandData[i].name}`);
  }
