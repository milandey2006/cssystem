    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gray-900 text-white py-20 px-4">
        <Image
          ...
          alt="Champion Security System project sites banner"
        />
        <div className="absolute inset-0 bg-black/30 z-10"></div>
        <div className="relative z-20 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-shadow-lg/30">Our Projects</h1>
...
function ProjectCard({ project }) {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
      <div className="relative">
        <ImageCarousel images={project.imageUrls} projectName={project.name} />
        {project.featured && (
