...
const services = [
  {
    ...
    description:
      "Our expert technicians ensure your security system is installed correctly and optimized for your specific needs. We handle everything from camera placement to system configuration.",
    features: [
  ...
  },
  {
    ...
    description:
      "Keep your security systems performing at their best with our comprehensive maintenance services. Regular check-ups prevent issues and extend equipment life.",
    features: [
  ...
  },
  {
    ...
    description:
      "Our professional monitoring center provides continuous surveillance, ensuring immediate response to any alerts from your security system, day or night.",
    features: [
...
export default function ServicesContent() {
  ...
  const tabContent = {
      ...
      features: [
        {
          ...
          description:
            "We assess your property and design a security system that provides optimal coverage with no blind spots.",
          color: "blue",
        },
        {
          icon: Wrench,
          ...
          description:
            "Our certified technicians handle all aspects of installation, from mounting cameras to running cables and configuring software.",
          color: "blue",
        },
        {
          icon: Clock,
          ...
          description:
            "We work efficiently to complete your installation with minimal disruption to your home or business.",
          color: "blue",
        },
      ],
    ...
    maintenance: {
      ...
      description:
        "Keep your security system performing at its best with our maintenance services. Regular maintenance prevents issues before they occur and extends the life of your equipment.",
      features: [
        {
          icon: Wrench,
          title: "Preventative Maintenance",
          description:
            "Regular system checks and cleaning to prevent issues and ensure optimal performance.",
          color: "green",
        },
        {
          icon: Settings,
          ...
          description:
            "Keep your system up-to-date with the latest firmware and software updates for enhanced security.",
          color: "green",
        },
        {
          icon: Phone,
          ...
          description:
            "Maintenance plan customers receive priority technical support and faster response times.",
          color: "green",
        },
      ],
    ...
    monitoring: {
      ...
      description:
        "Our monitoring center is staffed around the clock by trained security professionals who respond immediately to alerts from your system.",
      features: [
        {
          icon: Shield,
          title: "Continuous Surveillance",
          description:
            "Our monitoring center watches over your property 24/7, ensuring immediate response to any security events.",
          color: "purple",
        },
        {
          icon: Phone,
          ...
          description:
            "When an alarm is triggered, our team verifies the threat and dispatches emergency services if needed.",
          color: "purple",
        },
        {
          icon: Calendar,
          ...
          description:
            "Receive detailed monthly reports on system activity, alerts, and response times.",
          color: "purple",
        },
      ],
      ...
      >
        ...
        <ul className="mb-8 space-y-3">
          {service.features.map((feature) => (
            ...
            >
              <div
                className={`w-5 h-5 ${colors.featureBulletBg} rounded-full flex items-center justify-center mr-3 flex-shrink-0`}
              >
                <svg
        ...
        <button
          className={`w-full bg-gradient-to-r ${colors.buttonBg} text-white font-semibold rounded-xl py-3 ${colors.buttonHover} transition-all duration-200 shadow-md`}
        >
    ...
    <div>
      ...
      <section className="relative bg-gray-900 text-white py-20 px-4">
        <Image
          ...
          alt="Champion Security System services banner"
        />
        <div className="absolute inset-0 bg-black/50 z-10"></div>
        <div className="relative z-20 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Professional Security Services in Mumbai
          </h1>
          <p className="text-lg md:text-xl text-gray-300 mb-8">
            Expert installation, maintenance, and monitoring services for
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Learn more about each service and how we can help protect what
              matters most
            </p>
          </div>
              ...
              {Object.entries(tabContent).map(([key, content]) => (
                ...
                >
                  <div className="grid md:grid-cols-2 gap-12 items-center">
                    {/* Content Section */}
                    <div
                      className={`space-y-6 ${activeTab === "maintenance" ? "md:order-2" : ""}`}
                    >
                      <div>
                        ...
                        {content.features.map((feature, index) => {
                          ...
                          return (
                            <div key={index} className="flex items-start gap-4">
                              <div
                                className={`flex h-12 w-12 items-center justify-center rounded-full ${getColorClasses(feature.color).iconBg} ${getColorClasses(feature.color).iconText} flex-shrink-0`}
                              >
                    ...
                    {/* Image Section */}
                    <div
                      className={`relative rounded-xl overflow-hidden shadow-lg ${activeTab === "maintenance" ? "md:order-1" : ""}`}
                    >
